...
const ComplexUsers = () => {
    const [url, setUrl] = useState('https://jsoncraft.onrender.com/api/v1/listComplexUsers/6794af63ba66a9df4975831d'); // Default URL for complex users
    ...
    return (
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white font-mono">
            <h2 className="text-3xl font-bold text-blue-500 mb-4">Run API Fetch Script for Complex Users</h2>
            <p className="text-gray-400 mb-6">Run the script and fetch complex user data from your API URL.</p>
            ...
            <div className="bg-gray-800 p-4 rounded-md mb-6">
                ...
                <pre className="bg-gray-700 p-4 rounded-md text-sm overflow-x-auto">
                    {`fetch('https://jsoncraft.onrender.com/api/v1/listComplexUsers')
  ...
  .then(json => console.log(json))`}
            ...
            {/* Error Section */}
            {error && (
                <div className="bg-red-600 p-4 rounded-md text-white mb-6">
