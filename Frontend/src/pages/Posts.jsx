...
const Posts = () => {
    const [url, setUrl] = useState('https://jsoncraft.onrender.com/api/v1/listPosts/6794ac19ba66a9df49758255'); // Default URL
    ...
    const handleRunScript = async () => {
        ...
        try {
            ...
            setPosts({}); // In case of error, show empty object
        }
        setLoading(false);
    };
    ...
    return (
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white font-mono">
            <h2 className="text-3xl font-bold text-blue-500 mb-4">Run API Fetch Script</h2>
            <p className="text-gray-400 mb-6">Run the script and fetch data from your API URL.</p>
