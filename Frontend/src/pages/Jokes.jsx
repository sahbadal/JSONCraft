...
const Jokes = () => {
    ...
    const handleRunScript = async () => {
        ...
        try {
            ...
            setJokes(data); // Set the fetched data
        } catch (error) {
            console.error('Error fetching data:', error);
            setJokes({}); // In case of error, show empty object
        }
        setLoading(false);
    };
    ...
    return (
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white font-mono">
            <h2 className="text-3xl font-bold text-blue-500 mb-4">Run API Fetch Script for Jokes</h2>
            <p className="text-gray-400 mb-6">Run the script and fetch joke data from your API URL.</p>
