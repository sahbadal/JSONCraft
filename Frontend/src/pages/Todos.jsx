...
const Todos = () => {
    const [url, setUrl] = useState('https://jsoncraft.onrender.com/api/v1/listTodos/679279f3cf14e85388c05a5f'); // Default URL for todos
    ...
    const handleRunScript = async () => {
        ...
        try {
            ...
            setTodos(data); // Set the fetched data
        } catch (error) {
            console.error('Error fetching data:', error);
            setTodos({}); // In case of error, show empty object
        }
        setLoading(false);
    };
    ...
    return (
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white font-mono">
            <h2 className="text-3xl font-bold text-blue-500 mb-4">Run API Fetch Script for Todos</h2>
            <p className="text-gray-400 mb-6">Run the script and fetch todos data from your API URL.</p>
            ...
            <div className="bg-gray-800 p-4 rounded-md mb-6">
                ...
                <pre className="bg-gray-700 p-4 rounded-md text-sm overflow-x-auto">
                    {`fetch('https://jsoncraft.onrender.com/api/v1/listTodos')
