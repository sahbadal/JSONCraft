...
const Quotes = () => {
    const [url, setUrl] = useState('https://jsoncraft.onrender.com/api/v1/listQuotes/67927a9acf14e85388c05aae'); // Default URL for quotes
    ...
    const handleRunScript = async () => {
        ...
        try {
            ...
            setQuotes(data); // Set the fetched data
        } catch (error) {
            console.error('Error fetching data:', error);
            setQuotes({}); // In case of error, show empty object
        }
        setLoading(false);
    };
    ...
    return (
        <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white font-mono">
            <h2 className="text-3xl font-bold text-blue-500 mb-4">Run API Fetch Script for Quotes</h2>
            <p className="text-gray-400 mb-6">Run the script and fetch quote data from your API URL.</p>
            ...
            <div className="bg-gray-800 p-4 rounded-md mb-6">
                ...
                <pre className="bg-gray-700 p-4 rounded-md text-sm overflow-x-auto">
                    {`fetch('https://jsoncraft.onrender.com/api/v1/listQuotes')
